                ...
                <div class="bookly-form-group">
                    ...
                    <div>
                        <select class="bookly-select-mobile bookly-js-select-service">
                            ...
                            <option value="1" class="service-name-duration">Crown and Bridge (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 ) ?>)</option>
                            <option value="-1" class="service-name">Crown and Bridge</option>
                            <option value="2" class="service-name-duration">Teeth Whitening (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 2 ) ?>)</option>
                            <option value="-2" class="service-name">Teeth Whitening</option>
                            <option value="3" class="service-name-duration">Veneers (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 12 ) ?>)</option>
                            <option value="-3" class="service-name">Veneers</option>
                            <option value="4" class="service-name-duration">Invisalign (invisable braces) (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 24 ) ?>)</option>
                            <option value="-4" class="service-name">Invisalign (invisable braces)</option>
                            <option value="5" class="service-name-duration">Orthodontics (braces) (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 8 ) ?>)</option>
                            <option value="-5" class="service-name">Orthodontics (braces)</option>
                            <option value="6" class="service-name-duration">Wisdom tooth Removal (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 6 ) ?>)</option>
                            <option value="-6" class="service-name">Wisdom tooth Removal</option>
                            <option value="7" class="service-name-duration">Root Canal Treatment (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 16 ) ?>)</option>
                            <option value="-7" class="service-name">Root Canal Treatment</option>
                            <option value="8" class="service-name-duration">Dentures (<?php echo \Bookly\Lib\Utils\DateTime::secondsToInterval( 3600 * 48 ) ?>)</option>
