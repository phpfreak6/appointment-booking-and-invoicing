        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                if (BooklyL10nCustDialog.intlTelInput.enabled) {
                    element.find('#phone').intlTelInput({
                        ...
                        geoIpLookup: function (callback) {
                            jQuery.get(ajaxurl, {action: 'bookly_ip_info', csrf_token : BooklyL10nCustDialog.csrf_token}, function () {}, 'json').always(function (resp) {
				...
				scope.processForm = function() {
					...
					scope.form.id = element.find('#cid').val();
