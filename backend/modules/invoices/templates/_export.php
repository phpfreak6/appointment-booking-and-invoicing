...
<div id="bookly-export-invoices-dialog" class="modal fade" tabindex=-1 role="dialog">
    <div class="modal-dialog">
        <form action="<?php echo admin_url( 'admin-ajax.php?action=bookly_export_invoices' ) ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="export_invoices_delimiter"><?php _e( 'Delimiter', 'bookly' ) ?></label>
                        <select name="export_invoices_delimiter" id="export_invoices_delimiter" class="form-control">
