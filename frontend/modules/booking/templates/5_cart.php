    ...
    <div class="bookly-cart bookly-box">
        <table>
            ...
            <?php foreach ( $items_data as $key => $data ) : ?>
                ...
                <?php \Bookly\Lib\Proxy\Shared::renderCartItemInfo( $cart_items, $key, $positions, true ) ?>
            <?php endforeach ?>
            </tbody>
            ...
            <?php foreach ( $items_data as $key => $data ) : ?>
                ...
                <?php endforeach ?>
                <?php \Bookly\Lib\Proxy\Shared::renderCartItemInfo( $cart_items, $key, $positions['price'],false ) ?>
