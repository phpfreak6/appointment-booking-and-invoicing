...
abstract class Config
{
    ...
    {
        return array( 'AED', 'ARS', 'AUD', 'BDT', 'BGN', 'BHD', 'BRL', 'CAD', 'CHF', 'CLP', 'COP', 'CRC', 'CZK', 'DKK', 'DOP', 'EGP', 'EUR', 'GBP', 'GEL', 'GTQ', 'HKD', 'HRK', 'HUF', 'IDR', 'ILS', 'INR', 'ISK', 'JPY', 'KES', 'KRW', 'KZT', 'LAK', 'MUR', 'MXN', 'MYR', 'NAD', 'NGN', 'NOK', 'NZD', 'OMR', 'PEN', 'PHP', 'PKR', 'PLN', 'PYG', 'QAR', 'RMB', 'RON', 'RSD', 'RUB', 'SAR', 'SEK', 'SGD', 'THB', 'TRY', 'TWD', 'UAH', 'UGX', 'USD', 'VND', 'XAF', 'XOF', 'ZAR', 'ZMW', );
    }
     ...
     * @return bool
     */
    public static function isBooklyExpired()
    {
        ...
        if ( $result === null ) {
            ...
            if ( $server_error_period > 7 ) {
                ...
                if ( Plugin::getPurchaseCode() == '' ) {
                    $grace_start = get_option( Plugin::getPrefix() . 'grace_start' ) + get_option( 'gmt_offset' ) * HOUR_IN_SECONDS;
                    ...
                    if ( $unix_day >= $expiration_day ) {
                        ...
                        $result['bookly'] = 'in_grace';
                        $result['grace_remaining_days'] = $expiration_day - $unix_day;
                    }
                } else {
                    $result['bookly'] = 'verified';
                }
