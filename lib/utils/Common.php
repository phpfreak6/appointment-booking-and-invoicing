...
abstract class Common
{
    ...
    public static function formatPrice( $price )
    {
        ...
        switch ( get_option( 'bookly_pmt_currency' ) ) {
            ...
            case 'BDT' : return '৳' . number_format_i18n( $price, 2 );
            ...
            case 'PYG' : return '₲' . number_format_i18n( $price, 2 );
            ...
            case 'RSD' : return 'din.' . number_format_i18n( $price );
     ...
     * @param string $action
     */
    public static function csrf( $action = 'bookly' )
    {
        printf(
            '<input type="hidden" name="csrf_token" value="%s">',
            esc_attr( Lib\Utils\Common::getCsrfToken( $action ) )
        );
    }
     ...
     * @return string
     */
    public static function getCsrfToken( $action = 'bookly' )
    {
